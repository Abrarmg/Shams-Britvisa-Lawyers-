      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="text-center max-w-3xl mx-auto mb-12 sm:mb-16">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-3xl sm:text-4xl md:text-6xl font-display font-black text-brand-black mb-6 leading-tight">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
          <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="flex flex-col gap-6 p-8 sm:p-10 rounded-[24px] sm:rounded-[32px] bg-zinc-50 border border-zinc-100 hover:bg-white hover:shadow-[0_20px_50px_rgba(0,0,0,0.05)] transition-all duration-500 group"
          >
            <div className="flex items-center justify-between">
              <div className="w-14 h-14 sm:w-16 sm:h-16 bg-white rounded-xl sm:rounded-2xl shadow-sm flex items-center justify-center group-hover:scale-110 group-hover:bg-brand-red group-hover:text-white transition-all duration-300 text-brand-red">
            ...
            <div>
              <h3 className="text-xl sm:text-2xl font-bold text-brand-black mb-3">Regulated & Compliant</h3>
              <p className="text-zinc-500 leading-relaxed text-base sm:text-lg">Officially regulated by the IAA in Level 1 Immigration category (Reg No: F202200117).</p>
            </div>
          </motion.div>
          ...
          {credentials.slice(1).map((item, idx) => (
            ...
            >
              ...
              <div>
                <h3 className="text-xl sm:text-2xl font-bold text-brand-black mb-3">{item.title}</h3>
                <p className="text-zinc-500 leading-relaxed text-base sm:text-lg">{item.description}</p>
              </div>
            </motion.div>
          ))}
        </div>
