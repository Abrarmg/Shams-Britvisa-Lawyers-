    ...
    <section className="py-16 sm:py-24 bg-zinc-50 overflow-hidden">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 items-stretch">
          ...
          >
            <a href="https://ibb.co/sdTz9nLW" target="_blank" rel="noopener noreferrer" className="relative rounded-[24px] sm:rounded-[40px] overflow-hidden shadow-2xl group h-[300px] sm:h-[400px] block">
              <img 
              ...
              <div className="absolute bottom-6 sm:bottom-8 left-6 sm:left-8 right-6 sm:right-8">
                <div className="bg-white/10 backdrop-blur-md border border-white/20 p-4 sm:p-6 rounded-2xl">
                  <h3 className="text-white font-black text-xl sm:text-2xl mb-1 sm:text-2xl mb-2">Manchester HQ</h3>
                  <p className="text-white/80 text-xs sm:text-sm font-medium">Our central hub for UK immigration excellence.</p>
                </div>
              </div>
            </a>

            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
              <div className="bg-white p-6 sm:p-8 rounded-2xl sm:rounded-3xl border border-zinc-100 shadow-sm flex items-start gap-4">
          ...
          <motion.div
            ...
            whileInView={{ opacity: 1, x: 0 }}
            viewport={{ once: true }}
            className="relative rounded-[24px] sm:rounded-[40px] overflow-hidden shadow-2xl border-4 sm:border-8 border-white min-h-[350px] sm:min-h-[500px]"
          >
            <iframe 
